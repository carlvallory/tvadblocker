...
class PyTextractor:
    ...
    def get_image_text(self,
        ...
        return self._extract_text(
            loaded_image, boxes, percentage, display, numbers, ratio_width, ratio_height, config
        )
    ...
    def _extract_text(self, image, boxes, percent, display, numbers, ratio_width, ratio_height, config):
        extracted_text = []
